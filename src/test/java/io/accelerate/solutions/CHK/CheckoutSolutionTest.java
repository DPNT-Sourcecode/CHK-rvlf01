...
public class CheckoutSolutionTest {
    ...
    public void run() {
        ...
        assertThat(checkoutSolution.checkout("NNNM"), equalTo(135));
        ...
        assertThat(checkoutSolution.checkout("VVVVVV"), equalTo(80));
        assertThat(checkoutSolution.checkout("VVVVVVV"), equalTo(80));
